 ...
 */
export const getApiV1ServersServeridRegistries = async (serverid: number, options?: Parameters<typeof apiClient>[1]): Promise<ResponseListCredentialsData> => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetApiV1ServersServeridRegistriesQueryKey(serverid);
   ...
   return  { queryKey, queryFn, enabled: serverid !== null && serverid !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getApiV1ServersServeridRegistries>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export const postApiV1ServersServeridRegistries = async (serverid: number,
    createCredentialRequest: CreateCredentialRequest, options?: Parameters<typeof apiClient>[1]): Promise<ResponseGetCredentialData> => {
...
export const deleteApiV1ServersServeridRegistriesId = async (serverid: number,
    id: number, options?: Parameters<typeof apiClient>[1]): Promise<ResponseDeleteCredentialMessageData> => {

  return apiClient<ResponseDeleteCredentialMessageData>(getDeleteApiV1ServersServeridRegistriesIdUrl(serverid,id),
  {
    ...options,
    method: 'DELETE'
...
export const getApiV1ServersServeridRegistriesId = async (serverid: number,
    id: number, options?: Parameters<typeof apiClient>[1]): Promise<ResponseGetCredentialData> => {

  return apiClient<ResponseGetCredentialData>(getGetApiV1ServersServeridRegistriesIdUrl(serverid,id),
  {
    ...options,
    method: 'GET'
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetApiV1ServersServeridRegistriesIdQueryKey(serverid,id);
   ...
   return  { queryKey, queryFn, enabled: serverid !== null && serverid !== undefined && id !== null && id !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getApiV1ServersServeridRegistriesId>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export const putApiV1ServersServeridRegistriesId = async (serverid: number,
    id: number,
    updateCredentialRequest: UpdateCredentialRequest, options?: Parameters<typeof apiClient>[1]): Promise<ResponseGetCredentialData> => {

  return apiClient<ResponseGetCredentialData>(getPutApiV1ServersServeridRegistriesIdUrl(serverid,id),
  {
    ...options,
    method: 'PUT',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(updateCredentialRequest)
  }
);}
