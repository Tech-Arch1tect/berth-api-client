...
import type {
  ResponseEmpty,
  ResponseTOTPMessageData,
  ResponseTOTPSetupData,
  ResponseTOTPStatusData,
  TOTPDisableRequest,
  TOTPEnableRequest
} from '../models';
 ...
 */
export const postApiV1TotpDisable = async (tOTPDisableRequest: TOTPDisableRequest, options?: Parameters<typeof apiClient>[1]): Promise<ResponseTOTPMessageData> => {

  return apiClient<ResponseTOTPMessageData>(getPostApiV1TotpDisableUrl(),
  {
    ...options,
    method: 'POST',
 ...
 * @summary Enable TOTP
 */
export const postApiV1TotpEnable = async (tOTPEnableRequest: TOTPEnableRequest, options?: Parameters<typeof apiClient>[1]): Promise<ResponseTOTPMessageData> => {

  return apiClient<ResponseTOTPMessageData>(getPostApiV1TotpEnableUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
 ...
 */
export const getApiV1TotpSetup = async ( options?: Parameters<typeof apiClient>[1]): Promise<ResponseTOTPSetupData> => {

  return apiClient<ResponseTOTPSetupData>(getGetApiV1TotpSetupUrl(),
  {
    ...options,
    method: 'GET'
 ...
 */
export const getApiV1TotpStatus = async ( options?: Parameters<typeof apiClient>[1]): Promise<ResponseTOTPStatusData> => {

  return apiClient<ResponseTOTPStatusData>(getGetApiV1TotpStatusUrl(),
  {
    ...options,
    method: 'GET'
