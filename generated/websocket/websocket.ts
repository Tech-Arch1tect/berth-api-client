...
export const getWsApiServersServeridStacksStacknameEvents = async (serverid: number,
    stackname: string, options?: Parameters<typeof apiClient>[1]): Promise<unknown> => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetWsApiServersServeridStacksStacknameEventsQueryKey(serverid,stackname);
   ...
   return  { queryKey, queryFn, enabled: serverid !== null && serverid !== undefined && stackname !== null && stackname !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getWsApiServersServeridStacksStacknameEvents>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export const getWsApiServersServeridStacksStacknameOperationsOperationId = async (serverid: number,
    stackname: string,
    operationId: string, options?: Parameters<typeof apiClient>[1]): Promise<unknown> => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetWsApiServersServeridStacksStacknameOperationsOperationIdQueryKey(serverid,stackname,operationId);
   ...
   return  { queryKey, queryFn, enabled: serverid !== null && serverid !== undefined && stackname !== null && stackname !== undefined && operationId !== null && operationId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getWsApiServersServeridStacksStacknameOperationsOperationId>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetWsApiServersServeridStacksStacknameTerminalQueryKey(serverid,stackname);
   ...
   return  { queryKey, queryFn, enabled: serverid !== null && serverid !== undefined && stackname !== null && stackname !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getWsApiServersServeridStacksStacknameTerminal>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
